...
export default function EditRecipe() {
    ...
    useEffect(()=>{
        const getData=async()=>{
            await axios.get(`https://flyingplateapp-fcdfbffpcad6bwh4.canadacentral-01.azurewebsites.net/recipe/${id}`)
            .then(response=>{
    ...
    const onHandleSubmit = async (e) => {
        ...
        await axios.put(`https://flyingplateapp-fcdfbffpcad6bwh4.canadacentral-01.azurewebsites.net/recipe/${id}`, recipeData,{
            headers:{
