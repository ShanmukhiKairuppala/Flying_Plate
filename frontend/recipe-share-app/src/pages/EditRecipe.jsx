...
export default function EditRecipe() {
    ...
    useEffect(()=>{
        const getData=async()=>{
            await axios.get(`https://recipeapp-ashaatbbgpgbdabh.japaneast-01.azurewebsites.net/recipe/${id}`)
            .then(response=>{
    ...
    const onHandleSubmit = async (e) => {
        ...
        await axios.put(`https://recipeapp-ashaatbbgpgbdabh.japaneast-01.azurewebsites.net/recipe/${id}`, recipeData,{
            headers:{
